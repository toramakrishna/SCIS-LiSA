      ...
      <div className={cn('flex-1 space-y-2', isUser && 'flex flex-col items-end')}>
        ...
        {queryResponse && (
          <div className="space-y-2 w-full">
            ...
            {queryResponse.note && (
              <div className="p-3 bg-amber-50 dark:bg-amber-950/30 border-l-4 border-l-amber-500 rounded-lg">
                <div className="flex items-start gap-2">
                  <div className="flex items-center justify-center w-5 h-5 rounded-full bg-amber-500 text-white text-xs font-bold flex-shrink-0 mt-0.5">
                    i
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-amber-700 dark:text-amber-400 mb-1">Note</p>
                    <p className="text-xs text-amber-600 dark:text-amber-300">{queryResponse.note}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="border rounded-lg bg-slate-50 dark:bg-slate-900/50">
              <Button
                ...
                className="w-full flex items-center justify-between p-3 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg"
              >
