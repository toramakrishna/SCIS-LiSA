      ...
      <CardHeader className="pb-3 bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:from-blue-950/20 dark:to-purple-950/20">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            {faculty.designation && (
              <Badge variant={getDesignationColor(faculty.designation)} className="mt-2">
                {faculty.designation}
              </Badge>
            )}
          </div>
          <div className="flex flex-col items-end gap-2">
            <div className="flex items-center gap-3 text-sm">
              <div className="text-center p-2 rounded-lg bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-md">
                <div className="text-xl font-bold">{faculty.publication_count || 0}</div>
                <div className="text-xs opacity-90">Publications</div>
              </div>
              {faculty.h_index && (
                <div className="text-center p-2 rounded-lg bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-md">
                  <div className="text-xl font-bold">{faculty.h_index}</div>
